<?php
	// porky database access interface
	...
	do {
		...
		// $bufUTF8 = '{"porky":{"sqlDatabaseType":"SQLite","sqlServerAddress":"127.0.0.1","sqlDatabaseName":"testdb.sqlite3","sqlUsername":"Oliver","sqlPassword":"1234","sqlStatement":"SELECT * FROM messages"}}';
		...
		$sqlDatabaseType = $getRequestJSON["porky"]["sqlDatabaseType"];
		$sqlServerAddress = $getRequestJSON["porky"]["sqlServerAddress"];
		$sqlDatabaseName = $getRequestJSON["porky"]["sqlDatabaseName"];
		$sqlUsername = $getRequestJSON["porky"]["sqlUsername"];
		$sqlPassword = $getRequestJSON["porky"]["sqlPassword"];
		$sqlStatement = $getRequestJSON["porky"]["sqlStatement"];
